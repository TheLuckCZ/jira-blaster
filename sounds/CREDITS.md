...
These eleven one-shots are from **"The Essential Retro Video Game Sound Effects
Collection [512 sounds]"** by **Juhani Junkala**, released under
...
**gitignored** — only the twelve files actually used are committed.
...
| `ding.wav` | `General Sounds/Simple Bleeps/sfx_sounds_Blip9.wav` |
| `pickup.wav` | `General Sounds/Positive Sounds/sfx_sounds_powerup15.wav` |
...
size and still passes everything in these sources — the whole set is ~120 KB.
